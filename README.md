...
- FileReader ejecuta estado, cancelación compartida, resolución de etiquetas y conversión ordinaria de texto/binario/base64 en Rust con encoding_rs. El host conserva eventos, tareas, resultados del realm y el parser MIME; backing no ordinario mantiene manejo de plataforma. Se preservan las reentradas y resultados anteriores de jsdom. Ver [validación](reports/validation/file-reader.md).
