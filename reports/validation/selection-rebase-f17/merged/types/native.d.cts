...
export class NativeSelectionState {
  constructor();
  direction: number;
  readonly anchorIsStart: boolean;
  associate(hasOld: boolean, hasNew: boolean, same: boolean, startEqual: boolean, endEqual: boolean): boolean;
  orient(focusBeforeAnchor: boolean): void;
  static selectionType(hasRange: boolean, collapsed: boolean): string;
  static contains(startBefore: boolean, endAfter: boolean, partial: boolean): boolean;
  static statistics(): import('./index.cjs').NativeSelectionStatistics;
}
export const SelectionOperation: { readonly Anchor: 0; readonly Focus: 1; readonly AnchorNode: 2; readonly AnchorOffset: 3; readonly FocusNode: 4; readonly FocusOffset: 5; readonly IsCollapsed: 6; readonly RangeCount: 7; readonly Type: 8; readonly GetRangeAt: 9; readonly AddRange: 10; readonly RemoveRange: 11; readonly RemoveAllRanges: 12; readonly Collapse: 13; readonly CollapseToStart: 14; readonly CollapseToEnd: 15; readonly Extend: 16; readonly SetBaseAndExtent: 17; readonly SelectAllChildren: 18; readonly DeleteFromDocument: 19; readonly ContainsNode: 20; readonly ToString: 21; readonly AssociateRange: 22; };
export type SelectionOperation = (typeof SelectionOperation)[keyof typeof SelectionOperation];
export function selectionOperation(owner: object, operation: SelectionOperation, args: unknown[], helpers: object, receive: (value: unknown) => void): void;
/** Returns the original value within the caller's native scope, preserving identity and primitive exceptions. */
export function selectionOperationResult(owner: object, operation: SelectionOperation, args: unknown[] | undefined, helpers: object): unknown;
export function selectionOperationStatistics(): import('./index.cjs').SelectionOperationStatistics;
