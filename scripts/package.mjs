...
const runtimeFiles = ['index.cjs', 'index.mjs', 'native.cjs', 'native.mjs', 'native-tree.cjs',
  'parser-bridge.cjs', 'xml-parser.cjs', 'xml-serializer.cjs', 'tree-cursor.cjs', 'token-list.cjs', 'string-map.cjs', 'dom-rect.cjs', 'compatibility-licenses', 'private-require.cjs', 'data-bridge.cjs', 'host-unicode.cjs', 'range-state.cjs',
