...
- Prioridad de rendimiento: migrar el driver completo de asignación de slots por árbol. Las ráfagas con 100/1.000 slots miden 0,16×/0,14× frente a jsdom; el perfil completo atribuye 63,46% inclusivo a assignSlotableForTree. Reducir llamadas por slot sin cambiar el orden captura → señal → commit → backlinks ni la semántica del iterador ante reentrancia. Evidencia en reports/validation/slot-signals.md.
